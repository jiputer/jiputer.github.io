  ...
  return (
    <div name="projects" id="projects" className = "sections"> 
        <div   className="section">
            ...
            <a className="sectionText" href="https://github.com/jipperspippers/"> Available upon request, repo is not public due to plagiarism concerns</a>
            ...
            <a className="sectionText" href="https://github.com/jipperspippers/"> Available upon request but, currently being edited for a more cleaner representation of results....</a>
            ...
            <a className="sectionText" href="https://github.com/jipperspippers/RemainingBattery">Github Link</a>
